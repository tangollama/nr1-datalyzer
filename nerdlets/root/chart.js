...
import {
  ...
  Radio, Stack, StackItem, navigation
} from 'nr1';
...
function Nrql({ query, account }) {
  return (
    <div className="nrql-query-container" onClick={() => openChartBuilder(query, account)}>
...
class ChartPicker extends React.Component {
  ...
  render() {
    ...
    return (
      <Stack distributionType="trailing" className="chart-picker">
